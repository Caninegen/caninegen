...
class RoleScreen(Screens):
    ...
    def get_role_blurb(self):
        if self.the_cat.status == "warrior":
            ...
            output = f"{self.the_cat.name} is {game.clan.name}Pack's <b>cleverdog</b>. " \
            ...
            output = f"{self.the_cat.name} is a <b>cannydog</b>. Medicine cats are the healers of the Clan. " \
                     f"They treat " \
