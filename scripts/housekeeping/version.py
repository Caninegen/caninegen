...
def get_version_info():
    if get_version_info.instance is None:
        ...
        get_version_info.instance = VersionInfo(
            is_source_build, release_channel, version_number, sps_version, upstream, is_itch, is_sandboxed, git_installed, is_thonny)
...
class VersionInfo:
    def __init__(self, is_source_build: bool, release_channel: str, version_number: str, sps_version: str, upstream: str, is_itch: bool, is_sandboxed: bool, git_installed: bool, is_thonny: bool):
